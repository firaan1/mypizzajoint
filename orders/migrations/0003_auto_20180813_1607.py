# Generated by Django 2.0.3 on 2018-08-13 16:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0002_auto_20180813_1601'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='pizzarate',
            name='PizzaType',
            field=models.ForeignKey(limit_choices_to={'field': False, 'id__in': ({'pk': 4}, {'pk': 5})}, on_delete=django.db.models.deletion.CASCADE, related_name='pizza_type', to='orders.Attr'),
        ),
        migrations.AlterField(
            model_name='pizzarate',
            name='ToppingType',
