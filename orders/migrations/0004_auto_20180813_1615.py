...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0003_auto_20180813_1607'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='pizzarate',
            name='PizzaType',
            field=models.ForeignKey(limit_choices_to={'field': False, 'id__in': ({'pk': 4}, {'pk': 5}), 'value': True}, on_delete=django.db.models.deletion.CASCADE, related_name='pizza_type', to='orders.Attr'),
        ),
        migrations.AlterField(
            model_name='pizzarate',
            name='ToppingType',
